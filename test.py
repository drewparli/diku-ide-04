...
if __name__ == '__main__':
    ...
    data["components"]["circles"] = [None, None, None]
    data["components"]["circles"][0] = component_circles(pca, 0, 1)
    data["components"]["circles"][1] = component_circles(pca, 0, 2)
    data["components"]["circles"][2] = component_circles(pca, 1, 2)
